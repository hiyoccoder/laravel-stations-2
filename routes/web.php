...
Route::get('/admin/reservations/{id}', [AdminReservationsController::class, 'detail'])->name('admin.reservations.detail');
Route::put('/admin/reservations/{id}', [AdminReservationsController::class, 'edit'])->name('admin.reservations.edit');
