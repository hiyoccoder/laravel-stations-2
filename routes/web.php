...
Route::get('/movies', [MovieController::class, 'getMovies'])->name('movies.index')->middleware('auth');
Route::get('/movies/{id}', [MovieController::class, 'getMoviesDetail'])->name('movies.detail')->middleware('auth');
...
Route::get('/sheets', [SheetController::class, 'getSheets'])->name('sheets.index')->middleware('auth');
Route::get('/movies/{movie_id}/schedules/{schedule_id}/sheets', [SheetController::class, 'moviesSchedulesSheets'])->name('movies.schedules.sheets')->middleware('auth');
Route::get('/movies/{movie_id}/schedules/{schedule_id}/reservations/create', [SheetController::class, 'moviesSchedulesReservationsCreate'])->name('movies.schedules.reservations.create')->middleware('auth');
Route::post('/reservations/store', [SheetController::class, 'reservationsStore'])->name('reservations.store')->middleware('auth');
